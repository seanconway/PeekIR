...
-- Changes:
--   - Swapped Order: Triggers Radar BEFORE Gantry (Async).
--   - This ensures the Radar is definitely recording when the motor starts moving.
--   - Preserves the fast, asynchronous motor control from Rev 11.
...
-- INITIALIZATION
-- =================================================================================
WriteToLog("Starting SAR Scan Revision 12 (Radar First + Async Motor)...\n", "blue")
...
for y = 1, num_y_steps do
    ...
    -- Trigger Radar BEFORE Gantry (Rev 4/9 logic)
